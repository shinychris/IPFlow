...
from ipflow.api.v1.patents import router as patents_router
...
from ipflow.api.v1.ai_config import router as ai_config_router
...
api_router.include_router(trademarks_router)
