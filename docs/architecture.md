...
IPFlow 的主定位是知识产权申报材料辅助生成、整理、合规检查与导出工具。组织协作、订阅计费和管理后台是围绕材料处理流程提供的配套能力或可选模块。

### 1.1 架构目标

IPFlow v2.0 采用现代化的微服务-ready架构设计，支撑软著、专利、商标材料处理流程，具备以下特性：
...
|------|----------|------|
| v1.0 | 基础软著申请功能 | ✅ 已完成 |
| v2.0 | 材料生成工具增强、配套组织协作与订阅模块 | ✅ 已完成 |
| v2.1 | 专利材料辅助生成支持 | 🚧 计划中 |
| v2.2 | 商标材料整理与导出支持 | 📝 待开发 |
| v3.0 | AI辅助撰写 | 📝 待开发 |
