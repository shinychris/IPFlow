...
export interface IStorage {
  ...
  updateUser(id: string, updates: Partial<Pick<User, "displayName" | "password">>): Promise<User | undefined>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updateUser(id: string, updates: Partial<Pick<User, "displayName" | "password">>): Promise<User | undefined> {
