...
IPFlow 是一个面向**软件著作权、专利、商标**三类知识产权场景的申报材料辅助工具，重点支持材料生成、整理、核对与导出。它不是完整的申请管理平台、代理业务系统或强 SaaS 商业平台；组织、订阅和后台等模块为当前代码保留的配套能力，可按实际部署选择启用。

**核心功能:**
- 📝 **软著材料辅助**: 5步向导流程，自动代码抽取（60页），操作手册生成
- 🔬 **专利材料辅助**: 发明专利/实用新型/外观设计，权利要求书与说明书辅助撰写
- 🏷️ **商标材料辅助**: Nice 分类查询（45类），图样上传，材料准备
- 🏢 **组织协作（可选）**: 当前代码保留组织与成员协作能力，便于团队整理材料
- 💳 **订阅配额（配套）**: 当前代码保留计划、订阅与资源配额能力
- 📊 **后台管理（配套）**: 当前代码保留基础后台、审计与监控能力
- 🔍 **审计监控**: 全链路操作日志与健康监控
...
| 订阅 | `/api/v1/subscriptions/*` | 订阅与配额（配套能力） |
...
> 订阅、计费和配额能力为当前代码保留的配套模块，不构成 IPFlow 的核心产品定位。
...
- ⭐ **小型团队**：专业版（最推荐，性价比最高）
- 🏢 **中大型团队**：企业版（配套管理与私有化部署能力）
- 🏛️ **知识产权服务机构**：代理机构版（批量材料处理与白标能力，按需启用）
